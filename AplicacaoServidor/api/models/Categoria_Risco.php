    ...
    class CategoriaRisco {
        ...
        public function lista(){
            ...
            try {
                ...
                $sqlLista = "SELECT * FROM categoria_risco";
        ...
        public function create(){
            ...
            try {
                ...
                $sqlCreate = "INSERT INTO categoria_risco(nome,descricao) VALUES(?,?)";
                $conexao->exec('SET NAMES utf8');
        ...
        public function read(){
            ...
            try {
                ...
                $conexao = $db->conecta_mysql();
                $sqlRead = "SELECT * FROM categoria_risco WHERE codCategoriaRisco = ?";
                $conexao->exec('SET NAMES utf8');
                $stmtRead = $conexao->prepare($sqlRead);
                $stmtRead->bindParam(1,$this->codCategoriaRisco);
                $stmtRead->execute();
        ...
        public function update(){
            ...
            try {
                ...
                $sqlUpdate = "UPDATE categoria_risco SET nome = ?, descricao = ? WHERE codCategoriaRisco = ?";
                $conexao->exec('SET NAMES utf8');
        ...
        public function delete(){
            ...
            try {
                ...
                $sqlDelete = "DELETE FROM categoria_risco WHERE codCategoriaRisco = ?";
                $conexao->exec('SET NAMES utf8');
                $stmtDelete = $conexao->prepare($sqlDelete);
                $stmtDelete->bindParam(1,$this->codCategoriaRisco);
